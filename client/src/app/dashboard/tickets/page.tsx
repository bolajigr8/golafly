...
function TicketsContent() {
  ...
  const category =
    (searchParams.get('category') as 'Standard' | 'Premium' | 'VIP') ??
    undefined
  const status =
    (searchParams.get('status') as 'available' | 'selling_fast' | 'sold_out') ??
    undefined
  const sortBy = (searchParams.get('sortBy') ?? 'date') as string
